...
class Draggable {
  ...
  Draggable(elementOrElementList,
    ...
    // Edit: allow draggable on List of html Elements
    if(_elementOrElementList is !ElementList && _elementOrElementList is !Element){
      List<Element> list = _elementOrElementList;
      list.forEach((Element el){
        el.classes.add('dnd-transform-elementList');
      });
      _elementOrElementList = querySelectorAll('.dnd-transform-elementList');
      list.forEach((Element el){
        el.classes.remove('dnd-transform-elementList');
      });
